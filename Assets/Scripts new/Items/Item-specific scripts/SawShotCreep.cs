...
public class SawShotCreep : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            GameObject Bongo = Instantiate(creepy, gameObject.GetComponent<ItemSAWSHOT>().guyLatchedTo.transform.position - new Vector3(0,0,-1), transform.rotation);
            ...
            Bongo.GetComponent<DealDamage>().damageAmt = 1;
