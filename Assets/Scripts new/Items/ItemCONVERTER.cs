...
public class ItemCONVERTER : MonoBehaviour
{
    ...
    public void newWaveEffects()
    {
        ...
        gameObject.GetComponent<Attack>().damageBonus += 10 * instances * ((gameObject.GetComponent<HPDamageDie>().MaxHP - gameObject.GetComponent<HPDamageDie>().HP)/ gameObject.GetComponent<HPDamageDie>().MaxHP);
    }
