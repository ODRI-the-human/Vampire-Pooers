...
[CreateAssetMenu(fileName = "AbilityParams", menuName = "AbilityParams/HomingMine")]
public class homingMine : AbilityParams
{
    public override void ActivateAbility(GameObject dealer, GameObject target, Vector2 direction, bool isPlayerTeam, Material mat, int layer, string tag, bool overrideBulletSpawnMethod)
    {
        ...
        objoct.GetComponent<homingMineMovement>().currVector = new Vector3(direction.x, direction.y, 0);
    }
